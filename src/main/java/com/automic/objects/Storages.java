...
public class Storages extends ObjectTemplate {
	...
	public Storage getStorageFromObject(UC4Object object) {
	...
	public void viewStorageContent(String StorageName) throws IOException {
		...
		LOGGER.info(" ++ Storage Content for object: " + StorageName);
		while (it.hasNext()) {
	...
	private UploadBinary uploadStorageEntry(String storageName, String entryName, ContentType contentType, boolean isUpdate, String version,
			PlatformSwHwType platform, String pathToBinaryFile) throws TimeoutException, IOException {
	...
	public UploadBinary updateStorageEntryBinary(String storageName, String entryName, String pathToBinaryFile, String version)
			throws TimeoutException, IOException {
		// (UC4ObjectName storeObject, java.lang.String entryName, PlatformSwHwType osPlatformHw, boolean isUpdate, java.io.File inputFile
		UploadBinary req = uploadStorageEntry(storageName, entryName, ContentType.BINARY, true, version, PlatformSwHwType.ALL,
				pathToBinaryFile);
		return req;
	}

	public UploadBinary addStorageEntryBinary(String storageName, String entryName, String pathToBinaryFile, String version)
			throws TimeoutException, IOException {
		// (UC4ObjectName storeObject, java.lang.String entryName, PlatformSwHwType osPlatformHw, boolean isUpdate, java.io.File inputFile
		UploadBinary req = uploadStorageEntry(storageName, entryName, ContentType.BINARY, false, version, PlatformSwHwType.ALL,
				pathToBinaryFile);
		return req;
	}

	public UploadBinary updateStorageEntryText(String storageName, String entryName, String pathToTextFile, String version)
			throws TimeoutException, IOException {
		// (UC4ObjectName storeObject, java.lang.String entryName, PlatformSwHwType osPlatformHw, boolean isUpdate, java.io.File inputFile
		UploadBinary req = uploadStorageEntry(storageName, entryName, ContentType.TEXT, true, version, PlatformSwHwType.ALL,
				pathToTextFile);
		return req;
	}

	public UploadBinary addStorageEntryText(String storageName, String entryName, String pathToTextFile, String version)
			throws TimeoutException, IOException {
		// (UC4ObjectName storeObject, java.lang.String entryName, PlatformSwHwType osPlatformHw, boolean isUpdate, java.io.File inputFile
		UploadBinary req = uploadStorageEntry(storageName, entryName, ContentType.TEXT, false, version, PlatformSwHwType.ALL,
				pathToTextFile);
		return req;
	}
}

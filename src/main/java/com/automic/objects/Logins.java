...
public class Logins extends ObjectTemplate {
	...
	public Login getLoginFromObject(UC4Object object) {
		return (Login) object;
	}

	public void getLoginContent(Login login) throws IOException {
		// LOGGER.info("Content of Login: "+myLogin.getName());
		...
		while (it.hasNext()) {
			...
			LOGGER.info("Host: [" + host + "] Type: [" + def.getHostType() + "] Login: [" + def.getLoginInfo() + "]");
		}
	}

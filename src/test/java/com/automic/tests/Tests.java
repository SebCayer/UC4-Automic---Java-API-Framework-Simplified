...
public class Tests {
	 ...
	 * DO NOT USE THIS
	 * 
	 * @throws AutomicAEApiException
	 *
	 *
	 */

	public Tests(AECredentials myClientSource, AECredentials myClientTarget) throws IOException, SAXException, AutomicAEApiException {
		...
		FactBroker.exportImportFactory.CopyFolderContentBetweenClients(connSource, "0330/1_WORKLOAD_AUTOMATION/SALES.REPORTING/WORKFLOWS",
				connTarget, "0340/1_WORKLOAD_AUTOMATION/SALES.REPORTING/WORKFLOWS");
